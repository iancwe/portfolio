          ...
          <Row>
            <Col md={6}>
              ...
              <Row className='contactrow'>
                <span><a href='https://github.com/iancwe'><i className='icon ion-social-github iconab' /></a></span>
                <span><a href='https://www.linkedin.com/in/ian-c-064734144/'><i className='icon ion-social-linkedin iconab' /></a></span>
              </Row>

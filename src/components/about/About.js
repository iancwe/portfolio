          ...
          <Row>
            <Col md={6}>
              ...
              <Row className='contactrow'>
                <span><a href='https://github.com/iancwe'><i className='fa fa-github-square fa-3x' aria-hidden='true' />Github</a></span>
                <span><a href='https://www.linkedin.com/in/ian-c-064734144/'><i className='fa fa-linkedin-square fa-3x' aria-hidden='true' />Linkedin</a></span>
              </Row>
